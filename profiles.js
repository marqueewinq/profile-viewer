var profilesData = [
  {
    ...
    composition:
      "2-4 Skyweavers with Shuriken Cannon, Star Bolas and Close-combat weapon",
    abilities: [
      "Battle Focus",
      "Disparate Paths",
      "Acrobatic Grace: Each time an attack targets this unit, subtract 1 from the Hit roll.",
    ],
    keywords: ["Aeldari", "Fly", "Mounted", "Skyweavers", "Smoke"],
    faction: "Harlequins",
  },
  {
    name: "Voidweaver",
    ...
    keywords: ["Aeldari", "Fly", "Vehicle", "Voidweaver"],
    faction: "Harlequins",
  },
  {
    name: "Starweaver",
  ...
  },
  {
    ...
    rangedWeapons: [
      ...
      },
      {
        ...
        AP: -2,
        D: 1,
        rules: ["ANTI-INFANTRY 2+", "ASSAULT", "PISTOL"],
      },
      {
    ...
    composition:
      "1 Troupe Master with Shuriken Pistol, Troupe Master Blade and Flip-Belt",
    options: [
    ...
    keywords: ["Aeldari", "Grenades", "Infantry", "Character", "Troupe Master"],
    faction: "Harlequins",
  },
  {
    name: "Troupe",
    ...
    rangedWeapons: [
      ...
      },
      {
        ...
        AP: -2,
        D: 1,
        rules: ["ASSAULT", "ANTI-INFANTRY 2+", "PISTOL"],
      },
    ],
    meleeWeapons: [
      {
    ...
    composition:
      "1 Lead Player and 4-11 Players each with Harlequin Blade, Shuriken Pistol, and Flip Belt",
    keywords: ["Aeldari", "Grenades", "Infantry", "Troupe"],
    faction: "Harlequins",
  },
  {
    name: "Death Jester",
    ...
    composition:
      "1 Death Jester with Shrieker's Cannon, Jester's Blade and Flip Belt",
    abilities: [
      "Lone Operative",
      "Battle Focus",
      "Disparate Paths",
    ...
    keywords: ["Aeldari", "Character", "Death Jester", "Infantry"],
    faction: "Harlequins",
  },
  {
    name: "Shadowseer",
  ...
  },
  {
    ...
    keywords: ["Aeldari", "Character", "Epic Hero", "Infantry", "Solitaire"],
    faction: "Harlequins",
  },
];
